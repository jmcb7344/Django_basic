# Generated by Django 4.0.2 on 2022-02-19 12:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_laboral', models.CharField(choices=[('P', 'Produccion'), ('C', 'Calidad'), ('R', 'RRHH'), ('A', 'Administracion'), ('E', 'Expedicion'), ('T', 'Tecnica')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puesto', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app_RRHH.puestolaboral')),
            ],
        ),
    ]
